...
public class GUIChat extends javax.swing.JFrame {
    ...
    public GUIChat(Client client) {
        ...
        //Xuất thông báo client mới đã tham gia với username
        KhungChatThat.setText(client.username + " đã tham gia chat");
        TextTinNhan.setText("");
        
        //Chạy hàm chờ nhận tin nhắn khi server gửi đúng luồng đó
        listenForMessage();
    }
    
    //Hàm đóng bộ đọc ghi và socket của client lại
    ...
    private void NutGuiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NutGuiActionPerformed
        try {
            if (client.socket.isConnected()) {
                ...
                //Trong lúc gửi chờ nhận phản hồi thì sẽ khóa nút gửi và trường nhập tin
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
    	Socket socket = null ;
    	Client client = new Client(socket,"Minh");
