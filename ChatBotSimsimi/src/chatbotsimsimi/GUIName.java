...
public class GUIName extends javax.swing.JFrame {
    ...
    //Nút gửi tên người dùng cho server bắt đầu thực hiện việc trao đổi key rồi mới chat dc
    private void OkBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OkBtnActionPerformed
        if (TextName.getText().equals("")) {
            //Thông báo nếu ko nhập tên người dùng
            ...
            //tạo vòng lặp chờ server gửi key cho client
            while (true) {
                //Nhận được key thì break ra
                if (listenForMessage()) {
                    break;
                }
            }

            //Mở khung chat lên sau khi trao đổi key xong truyền và client vừa nhận dc key tương ứng
    ...
    //Hàm lắng nghe và trả secret key cho Server
        ...
        if (client.socket.isConnected()) {
            try {
                ...
                if (msgFromGroupChat.contains("#publickey#")) {
                    ...
                    //Chuyển SecretKey về dạng string
    ...
    //Hàm gửi tên người dùng cho server
